--[[ $Id: frFR.lua 81536 2008-09-08 14:18:47Z pettigrow $ ]]
...
L["Configure actionbar paging when the %s key is down."] = "Configure le changement de page d'actions quand la touche %s est enfoncée."
